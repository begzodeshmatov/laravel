            ...
            <div class="carousel-inner">
                @foreach ($banner as $ban)
                    <div class="carousel-item active">
                        <img src="/rasmlar/{{ $ban->image }}" style="filter: brightness(0.4);" width="100"
                ...
                @foreach ($malumot as $mal)
                    <div class="col-lg-4 col-md-12 col-12">
                        <div class="features-img">
                            <img style="width:600px; height:300px;" src="/rasmlar/{{ $mal->image }}"
                    ...
                    <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-4">
                        <div class="features-text">
                            ...
                            <a href="{{ 'register' }}" onclick="alert('Ro\'yxatdan o\'tishni istaysizmi???')"
                        ...
                        <div class="card text-white text-center bg-light pb-2">
                            <div class="card-body">
                                <div class="img-area mb-4">
                                    <img style="width:600px; height:300px;" src="/rasmlar/{{ $kur->image }}"
                    ...
                    <div class="col-12 col-md-12 col-lg-4">
                        <div class="card text-center bg-white pb-2">
                            <div class="card-body text-dark">
                                <div class="img-area mb-4">
                                    <img style="width:600px; height:300px;" src="/rasmlar/{{ $se->image }}"
                                        alt="Rasm chiqmadi." class="img-fluid">
                                </div>
                ...
                @foreach ($lesson as $les)
                    <div class="col-12 col-md-12 col-lg-4">
                        <div class="card text-center bg-white pb-2">
                            <div class="card-body text-dark">
                                <div class="img-area mb-4">
                                    <img style="width:600px; height:300px;" src="/rasmlar/{{ $les->image }}"
                                        alt="" class="img-fluid">
                                </div>
