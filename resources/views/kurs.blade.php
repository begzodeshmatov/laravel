        ...
        <div class="card-header">
          ...
          <div class="form-group">
             ...
             <div class="input-group">
              ...
              <a href="/clearkurs" class="btn btn-primary"><i style="font-size:17px;" class='bx bx-trash'></i></a>
          </div>
        ...
        <form  method="GET" action="/searchkurss">
          <div class="input-group">
            <input type="search" class="form-control" name="searchkurss" placeholder="Search">
                ...
                <a href="/clearkurss" class="btn btn-success"><i style="font-size:20px;" class='bx bx-trash'></i></a>
          </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        @foreach($kurs as $kur)
                          <tr class="even pointer">
                            ...
                            <td class=" "> <img src="/rasmlar/{{$kur->image}}" width="100" height="100" alt="Rasm chiqmadi"></td>
                            <td>
                            <a  data-bs-toggle="modal" class="btn btn-primary" data-bs-target="#exampleModal{{$kur->id}}" href="#"><i class='bx bx-pencil'></i></a>
                            <a  data-bs-toggle="modal" class="btn btn-danger" data-bs-target="#deleteKurs{{$kur->id}}" href="#"><i class='bx bx-trash' ></i></a>
                           

                                <!-- Modal -->
           
<div class="modal fade" id="exampleModal{{$kur->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Kurs Edit</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="/kursEditSave/{{$kur->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">Name</label>
                        <input type="text" class="form-control" name="name" value="{{$kur->name}}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" value="{{$kur->title}}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Image</label>
                    ...
                    <div class="mb-3">
                      <label class="form-label">Kurs</label>
                        <select class="form-select" aria-label="Default select example" name="kurs" value="{{$kur->kurs}}">
                            <option selected>Fan tanlang...</option>
                            <option value="1">Ona tili</option>
                            <option value="2">Ingliz tili</option>
                            <option value="3">Tarix</option>
                    ...
                    <button class="btn btn-primary">Edit</button>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="deleteKurs{{$kur->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                            <div class="modal-header">
