        ...
        <form  method="GET" action="/searchbanner">
          <div class="input-group">
            <input type="search" class="form-control" name="searchbanner" placeholder="Search">
                ...
                <a href="/clearbanner" class="btn btn-success"><i style="font-size:20px;" class='bx bx-trash'></i></a>
          </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        @foreach($banner as $ban)
                          <tr class="even pointer">
                            ...
                            <td class=" "> <img src="/rasmlar/{{$ban->image}}" width="100" height="100" alt="Rasm chiqmadi"></td>
                            <td>
                            <a  data-bs-toggle="modal" class="btn btn-primary" data-bs-target="#exampleModal{{$ban->id}}" href="#"><i class='bx bx-pencil'></i></a>
                            <a  data-bs-toggle="modal" class="btn btn-danger" data-bs-target="#deleteBanner{{$ban->id}}" href="#"><i class='bx bx-trash' ></i></a>
                           

                                <!-- Modal -->
           
<div class="modal fade" id="exampleModal{{$ban->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Banner Edit</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="/bannerEditSave/{{$ban->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">Name</label>
                    ...
                    <button class="btn btn-primary">Edit</button>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="deleteBanner{{$ban->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                            <div class="modal-header">
