  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <button style="margin-left: 675px;" class="btn btn--add btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa fa-plus"></i></button>
        <div class="col-md-5">
          <div class="form-group">
             ...
             <div class="input-group">
              ...
              <button type="submit" class="btn btn-primary"><i style="font-size:20px;" class='bx bx-search'></i></button>
              <a href="/clear" class="btn btn-primary"><i style="font-size:20px;" class='bx bx-trash'></i></a>
          </div>
        </form>
</div>
       </div> 
        ...
        <form  method="GET" action="/searchch">
          <div class="input-group">
            <input type="search" class="form-control" name="searchch" placeholder="Search">
                ...
                <a href="/clearyangilik" class="btn btn-success"><i style="font-size:20px;" class='bx bx-trash'></i></a>
          </div>
                                ...
                                <form action="/yangilikSave" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="news">
                                          ...
                                          <option value="2">O'zbekiston yangiliklari</option>
                                          <option value="3">Jahon yangiliklari</option>
                                           @error('news')  <p style="color:red;">{{$message}}</p>   @enderror
                                        </select>
                        ...
                        <tbody>
                          @foreach($yangilik as $yan)
                            <tr class="even pointer">
                              ...
                              <td>
                              <a  data-bs-toggle="modal" class="btn btn-primary" data-bs-target="#exampleModal{{$yan->id}}" href="#"><i class='bx bx-pencil'></i></a>
                              <a  data-bs-toggle="modal" class="btn btn-danger" data-bs-target="#deleteYangilik{{$yan->id}}" href="#"><i class='bx bx-trash' ></i></a>
                           

                                <!-- Modal -->
           
<div class="modal fade" id="exampleModal{{$yan->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Yangilik Edit</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="/yangilikEditSave/{{$yan->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">Name</label>
                        <input type="text" class="form-control" name="name" value="{{$yan->name}}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" value="{{$yan->title}}">
                    </div>
                    <div class="mb-3">
                      <label class="form-label">News</label>
                        <select class="form-select" aria-label="Default select example" name="news" value="{{$yan->news}}">
                           <!-- <option selected>Yangiliklarni tanlang...</option> -->
                            <option value="Jizzax yangiliklari">Jizzax yangiliklari</option>
                            <option value="O'zbekiston yangiliklari">O'zbekiston yangiliklari</option>
                            <option value="Jahon yangiliklari">Jahon yangiliklari</option>
                        </select>
                    </div>
                    <button class="btn btn-primary">Edit</button>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="deleteYangilik{{$yan->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <p>Haqiqatdan ham {{$yan->name}} ni o'chirmoqchimisiz</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Yo'q</button>
                                <a href="/deleteyan/{{$yan->id}}" class="btn btn-primary">Xa</a>
                            </div>
                            </div>
                        </div>
                        </div>
