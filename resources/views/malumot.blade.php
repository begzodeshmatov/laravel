        ...
        <form  method="GET" action="/searchmalumot">
          <div class="input-group">
            <input type="search" class="form-control" name="searchmalumot" placeholder="Search">
                ...
                <a href="/clearmalumot" class="btn btn-success"><i style="font-size:20px;" class='bx bx-trash'></i></a>
          </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        @foreach($malumot as $mal)
                          <tr class="even pointer">
                            ...
                            <td class=" "> <img src="/rasmlar/{{$mal->image}}" width="100" height="100" alt="Rasm chiqmadi"></td>
                            <td>
                            <a  data-bs-toggle="modal" class="btn btn-primary" data-bs-target="#exampleModal{{$mal->id}}" href="#"><i class='bx bx-pencil'></i></a>
                            <a  data-bs-toggle="modal" class="btn btn-danger" data-bs-target="#deleteMalumot{{$mal->id}}" href="#"><i class='bx bx-trash' ></i></a>
                           

                                <!-- Modal -->
           
<div class="modal fade" id="exampleModal{{$mal->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Malumot Edit</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="/malumotEditSave/{{$mal->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">Name</label>
                        <input type="text" class="form-control" name="name" value="{{$mal->name}}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" value="{{$mal->title}}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Image</label>
                    ...
                    <button class="btn btn-primary">Edit</button>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="deleteMalumot{{$mal->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                            <div class="modal-header">
