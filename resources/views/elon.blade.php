                ...
                <tbody>
                    @foreach ($elon as $se)
                        <tr class="even pointer">
                            ...
                            <td class=" ">{{ $se->news }}</td>
                            <td class=" "> <img src="/rasmlar/{{ $se->image }}" width="100" height="100"
                                    alt="Rasm chiqmadi"></td>
                            <td class=" "> <a href="/filelar/{{ $se->file }}"
                                    target="_blank">{{ $se->file }}</a></td>
                            <td>
                                <a data-bs-toggle="modal" class="btn btn-primary"
                                    data-bs-target="#exampleModal{{ $se->id }}" href="#"><i
                                        class='bx bx-pencil'></i></a>
                                <a data-bs-toggle="modal" class="btn btn-danger"
                                    data-bs-target="#deleteElon{{ $se->id }}" href="#"><i
                                        class='bx bx-trash'></i></a>


                                <!-- Modal -->

                                <div class="modal fade" id="exampleModal{{ $se->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="/elonEditSave/{{ $se->id }}" method="POST"
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="deleteElon{{ $se->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
